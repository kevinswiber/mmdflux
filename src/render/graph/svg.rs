...
pub(crate) fn build_svg_layout_with_flags(
    ...
    engine_flags: Option<&crate::engines::graph::algorithms::layered::LayoutConfig>,
) -> GraphGeometry {
...
fn inject_routed_paths(
    ...
    let routed = crate::render::graph::routing::route_graph_geometry(diagram, geom, edge_routing);
